...
void main() {
  testWidgets('CustomAppBar correctly shows the passed title and actions', (WidgetTester tester) async {
    ...
    expect(find.byWidgetPredicate((widget) => widget is AppBarTitle && widget.title == testTitle), findsOneWidget);
